...
jQuery('.hamburger-menu').on('click',function(el){jQuery('.uabb-off-canvas-menu').css({'left':'0px','transition':'1.5s'});});jQuery('.uabb-menu-close-btn').on('click',function(el){jQuery('.uabb-off-canvas-menu').css({'left':'0px','transition':'1.5s'});});(function($){FLBuilderPostGrid=function(settings)
