...
jQuery('.hamburger-menu').on('click',function(el){jQuery('.uabb-off-canvas-menu').css({'left':'0px','transition':'1.5s'});});jQuery('.uabb-menu-close-btn').on('click',function(el){jQuery('.uabb-off-canvas-menu').css({'left':'0px','transition':'1.5s'});});jQuery(function($){$(function(){$('.fl-node-5a00c985e2be2 .fl-photo-img').on('mouseenter',function(e){$(this).data('title',$(this).attr('title')).removeAttr('title');}).on('mouseleave',function(e){$(this).attr('title',$(this).data('title')).data('title',null);});});});(function($){FLBuilderPostGrid=function(settings)
